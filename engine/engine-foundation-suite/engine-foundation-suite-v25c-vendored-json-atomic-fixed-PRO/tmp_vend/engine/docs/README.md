# Engine Docs (Generic, Product-Agnostic)

**Generated:** 2026-02-05

These docs describe the **generic JSON✯Atomic Engine** — neutral, reusable, and opinionated by default.
Use these documents to understand invariants, specs, security posture, and operational playbooks.
