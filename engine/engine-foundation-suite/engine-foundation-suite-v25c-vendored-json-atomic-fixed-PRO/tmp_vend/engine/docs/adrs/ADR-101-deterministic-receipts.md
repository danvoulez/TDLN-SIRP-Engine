# ADR-101: Deterministic Receipts & Offline Verification

Status: Accepted

Decision: Canonicalization + content addressing; receipts include hash_chain; bundles enable offline verify.
